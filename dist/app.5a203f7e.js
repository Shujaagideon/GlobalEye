...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../js/utils/smoothScroll.js":[function(require,module,exports) {
"use strict";
...
var SmoothScroll = /*#__PURE__*/function () {
  ...
  _createClass(SmoothScroll, [{
    key: "validateOptions",
    value: function validateOptions(ops) {
      for (var prop in ops) {
    ...
    value: function init(options) {
      ...
      if (performance.navigation.type == performance.navigation.TYPE_RELOAD) {
        this.wrapperOffset = 0.0; // console.info("This page is reloaded");
...
},{}],"../../node_modules/gsap/dist/ScrollToPlugin.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
...
},{}],"../js/animations/animations.js":[function(require,module,exports) {
"use strict";
...
var Animations = /*#__PURE__*/function () {
  function Animations(text) {
    ...
    if (text !== undefined) {
      this.text = new _splitTextJs.default(text);
      console.log(this.text);
    }

    this.introTl = _gsap.default.timeline({
      onComplete: function onComplete() {
  ...
  _createClass(Animations, [{
    key: "introAnim",
    value: function introAnim() {
      var introText = new _splitTextJs.default(document.querySelector('.intro h1'));
    ...
    key: "textAnim",
    value: function textAnim(text) {
      var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 150;
      var stagger = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.config.stagger;
      this.introTl.from(text, {
        scrollTrigger: {
          trigger: text // markers: true
    ...
    value: function animate() {
      ...
      _toConsumableArray(document.querySelectorAll('.text h1')).forEach(function (text) {
        var newText = new _splitTextJs.default(text);

        _this.textAnim(newText.chars);
      });

      _toConsumableArray(document.querySelectorAll('.text h2')).forEach(function (text) {
        var newText = new _splitTextJs.default(text);

        _this.textAnim(newText.chars);
      });

      _toConsumableArray(document.querySelectorAll('.text h3')).forEach(function (text) {
        var newText = new _splitTextJs.default(text);

        _this.textAnim(newText.chars);
      });

      _toConsumableArray(document.querySelectorAll('.text h4')).forEach(function (text) {
        var newText = new _splitTextJs.default(text);

        _this.textAnim(newText.chars);
      });

      _toConsumableArray(document.querySelectorAll('.text p')).forEach(function (text) {
        var newText = new _splitTextJs.default(text);

        _this.textAnim(newText.chars, 0, 0.005);
      });
...
},{"gsap":"../../node_modules/gsap/index.js","split-text-js":"../../node_modules/split-text-js/SplitTextJS.js","gsap/dist/ScrollTrigger":"../../node_modules/gsap/dist/ScrollTrigger.js","gsap/dist/ScrollToPlugin":"../../node_modules/gsap/dist/ScrollToPlugin.js"}],"../js/app.js":[function(require,module,exports) {
"use strict";

var _smoothScroll = _interopRequireDefault(require("./utils/smoothScroll"));

var _animations = _interopRequireDefault(require("./animations/animations"));
...
void new ( /*#__PURE__*/function () {
  function _class() {
    _classCallCheck(this, _class);

    this.textAnimation = new _animations.default();
    this.introElements = {
  ...
  _createClass(_class, [{
    ...
    value: function Start() {
      new _smoothScroll.default();
      new _animations.default(this.introElements.text, this.introElements.config);
    }
  }]);

  return _class;
}())();
},{"./utils/smoothScroll":"../js/utils/smoothScroll.js","./animations/animations":"../js/animations/animations.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
